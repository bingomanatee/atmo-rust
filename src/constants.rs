...
pub const LEVEL_AMT: f64 = 0.3; // Percentage for volume levelling between cells
...
pub const ANOMALY_ENERGY_AMOUNT: f64 = CELL_JOULES_START * 0.05; // 2% of starting energy (was 20%)
