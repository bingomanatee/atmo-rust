...
pub const ANOMALY_ENERGY_AMOUNT: f64 = CELL_JOULES_START * 0.02; // 2% of starting energy (was 20%)
pub const ANOMALY_VOLUME_AMOUNT: f64 = AVG_STARTING_VOLUME_KM_3 * 0.01; // 1% of starting volume (was 10%)
